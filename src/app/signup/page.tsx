            ...
            <div className="w-full h-screen flex justify-center items-center bg-black bg-opacity-80 px-4 sm:px-0">
                ...
                <h1 className="text-center text-2xl sm:text-3xl font-bold bg-orange-500 text-black rounded-t-lg m-0 py-4">Sign Up</h1>
                    <form onSubmit={handleSignUp} className="p-6 sm:p-8">
                        ...
                        <input type="email" name="" placeholder="New Email Id" value={email} onFocus={clearErrorMessage} onChange={(e) => setEmail(e.target.value)} className="py-2 px-3 w-full text-black text-lg font-light outline-none border border-black mt-4 sm:mt-5"/>
                        <input type="password" name="" placeholder="New Password" value={password} onFocus={clearErrorMessage} onChange={(e) => setPassword(e.target.value)} className="py-2 px-3 w-full text-black text-lg font-light outline-none border border-black mt-4 sm:mt-5" />
                        <input type="password" name="" placeholder="Confirm Password" value={confirmPassword} onFocus={clearErrorMessage} onChange={(e) => setConfirmPassword(e.target.value)} className="py-2 px-3 w-full text-black text-lg font-light outline-none border border-black mt-4 sm:mt-5" />
